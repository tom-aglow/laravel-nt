...
//        check if form has a file field and if file is valid
        if ($request->hasFile($file) && $request->file($file)->isValid()) {
//            store the file into variable and remember its properties
            $this->file = $request->file($file);
            $this->fillProps();

//            check validation rules
//            TODO change error messages for file uploader using localization
